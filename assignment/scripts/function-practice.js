...
console.log(helloName('Anniessa'));
console.log(helloName('Ernie'));
...
let listOfNums = [3,4,5,6];
function getLast(array) {
  return (array === null) ? 'undefined' : (array[array.length -1]);
}
console.log(getLast(listOfNums));
...
let listOfNumbers = [1,2,3,4,5,6,7,10]
...
console.log("Sum is " + sumAll(listOfNumbers));

// 10. Function to return a new array of all positive (greater than zero)
//     numbers contained in an input array. If there are no positive numbers
//     return an empty array. Note: The input array should not change.
let inputArray = [-22, -14, -1, 0, 3, 5, 6, 77]
function findPositives (array) {
const positives = array.filter(num => num > -1);
return positives;
}
console.log(findPositives(inputArray));
